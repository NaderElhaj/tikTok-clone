...
const Discover = () => {
  ...
  const activeTopicStyle =
    "hover:text-white hover:bg-primary xl:border-2 xl:border-[#f51997] px-3 py-2 rounded xl:rounded-full flex items-center justify-center cursor-pointer text-[#ff1997]";
  const topicStyle =
